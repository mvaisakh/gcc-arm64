...
enum unspec {
  ...
  UNSPEC_ZIP1Q = 316,
  UNSPEC_ZIP2Q = 317,
  UNSPEC_COND_CMPEQ_WIDE = 318,
  UNSPEC_COND_CMPGE_WIDE = 319,
  UNSPEC_COND_CMPGT_WIDE = 320,
  UNSPEC_COND_CMPHI_WIDE = 321,
  UNSPEC_COND_CMPHS_WIDE = 322,
  UNSPEC_COND_CMPLE_WIDE = 323,
  UNSPEC_COND_CMPLO_WIDE = 324,
  UNSPEC_COND_CMPLS_WIDE = 325,
  UNSPEC_COND_CMPLT_WIDE = 326,
  UNSPEC_COND_CMPNE_WIDE = 327,
  UNSPEC_COND_FABS = 328,
  UNSPEC_COND_FADD = 329,
  UNSPEC_COND_FCADD90 = 330,
  UNSPEC_COND_FCADD270 = 331,
  UNSPEC_COND_FCMEQ = 332,
  UNSPEC_COND_FCMGE = 333,
  UNSPEC_COND_FCMGT = 334,
  UNSPEC_COND_FCMLA = 335,
  UNSPEC_COND_FCMLA90 = 336,
  UNSPEC_COND_FCMLA180 = 337,
  UNSPEC_COND_FCMLA270 = 338,
  UNSPEC_COND_FCMLE = 339,
  UNSPEC_COND_FCMLT = 340,
  UNSPEC_COND_FCMNE = 341,
  UNSPEC_COND_FCMUO = 342,
  UNSPEC_COND_FCVT = 343,
  UNSPEC_COND_FCVTZS = 344,
  UNSPEC_COND_FCVTZU = 345,
  UNSPEC_COND_FDIV = 346,
  UNSPEC_COND_FMAX = 347,
  UNSPEC_COND_FMAXNM = 348,
  UNSPEC_COND_FMIN = 349,
  UNSPEC_COND_FMINNM = 350,
  UNSPEC_COND_FMLA = 351,
  UNSPEC_COND_FMLS = 352,
  UNSPEC_COND_FMUL = 353,
  UNSPEC_COND_FMULX = 354,
  UNSPEC_COND_FNEG = 355,
  UNSPEC_COND_FNMLA = 356,
  UNSPEC_COND_FNMLS = 357,
  UNSPEC_COND_FRECPX = 358,
  UNSPEC_COND_FRINTA = 359,
  UNSPEC_COND_FRINTI = 360,
  UNSPEC_COND_FRINTM = 361,
  UNSPEC_COND_FRINTN = 362,
  UNSPEC_COND_FRINTP = 363,
  UNSPEC_COND_FRINTX = 364,
  UNSPEC_COND_FRINTZ = 365,
  UNSPEC_COND_FSCALE = 366,
  UNSPEC_COND_FSQRT = 367,
  UNSPEC_COND_FSUB = 368,
  UNSPEC_COND_SCVTF = 369,
  UNSPEC_COND_UCVTF = 370,
  UNSPEC_LASTA = 371,
  UNSPEC_LASTB = 372,
  UNSPEC_ASHIFT_WIDE = 373,
  UNSPEC_ASHIFTRT_WIDE = 374,
  UNSPEC_LSHIFTRT_WIDE = 375,
  UNSPEC_LDFF1 = 376,
  UNSPEC_LDNF1 = 377,
  UNSPEC_FCADD90 = 378,
  UNSPEC_FCADD270 = 379,
  ...
  UNSPEC_FCMLA270 = 383,
  UNSPEC_FCMUL = 384,
  UNSPEC_FCMUL_CONJ = 385,
  UNSPEC_FCMLA_CONJ = 386,
  UNSPEC_FCMLA180_CONJ = 387,
  UNSPEC_ASRD = 388,
  UNSPEC_ADCLB = 389,
  UNSPEC_ADCLT = 390,
  UNSPEC_ADDHNB = 391,
  ...
  UNSPEC_CMLA270 = 404,
  UNSPEC_CMLA90 = 405,
  UNSPEC_CMLA_CONJ = 406,
  UNSPEC_CMLA180_CONJ = 407,
  UNSPEC_CMUL = 408,
  UNSPEC_CMUL_CONJ = 409,
  ...
  UNSPEC_SMULLB = 456,
  UNSPEC_SMULLT = 457,
  UNSPEC_SQCADD270 = 458,
  UNSPEC_SQCADD90 = 459,
  UNSPEC_SQDMULLB = 460,
  UNSPEC_SQDMULLBT = 461,
  UNSPEC_SQDMULLT = 462,
  UNSPEC_SQRDCMLAH = 463,
  UNSPEC_SQRDCMLAH180 = 464,
  UNSPEC_SQRDCMLAH270 = 465,
  UNSPEC_SQRDCMLAH90 = 466,
  UNSPEC_SQRSHRNB = 467,
  UNSPEC_SQRSHRNT = 468,
  UNSPEC_SQRSHRUNB = 469,
  UNSPEC_SQRSHRUNT = 470,
  UNSPEC_SQSHRNB = 471,
  UNSPEC_SQSHRNT = 472,
  UNSPEC_SQSHRUNB = 473,
  UNSPEC_SQSHRUNT = 474,
